...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <ol class="carousel-indicators">
      ...
      <li data-target="#carouselExampleIndicators" data-slide-to="2" style="margin-left: 40px;"></li>
    </ol>
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="https://images.pexels.com/photos/324028/pexels-photo-324028.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="https://images.pexels.com/photos/683039/pexels-photo-683039.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Third slide">
      </div>
    </div>
  </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-4">
                    <div class="card" style="width: 300px;margin: auto;">
                      <img src="https://images.pexels.com/photos/302899/pexels-photo-302899.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="card-img-top">
                      <div class="card-body">
  ...
  <div class="grid-container">
    <div class="grid-item-one">
      <img id="secondImage" src="outdoorshop.jpg" alt="">
    </div>

    <div class="grid-item-two">
      <p class="titleForInfos">Our Locations</p>
      <p class="tinyDetails">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br>
        Quisque ligula tortor, aliquam a euismod vitae, lacinia eu <br>
        purus. Suspendisse a
      </p>
  ...
  <div class="grid-container">
    <div class="grid-item1">
      <p class="titleForInfos">Become a Member</p>
      <p class="tinyDetails">Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br>
        Quisque ligula tortor, aliquam a euismod vitae, lacinia eu <br>
        purus. Suspendisse a
      </p>
